...
def main():
	...
	y_train_data = y_scaler.fit_transform(y_train_data)
	...
	y_test_data = y_scaler.fit_transform(y_test_data)
	...
	#Train the model
	model.fit(x_train, y_train, batch_size=5, epochs=5, validation_split=0.15)
	# Creates a HDF5 file 'my_model.h5'
	model_name = 'sbux_5par_model.h5' 
	...
	rmse = np.sqrt(np.mean(((predictions - y_scaler.inverse_transform(y_test))**2)))
	...
	plt.plot(y_scaler.inverse_transform(y_test))
	plt.show()'''
